...
// andres mauricio Custom Shortcode
require_once (ENGINE_LIB . '/engine-shortcodes/shortcode-rubrica.php');
...
// andres mauricio Custom Block
require_once(AQPB_PATH . 'blocks/engine-rubrica-block.php');
...
aq_register_block('Engine_Rubrica_Block');
